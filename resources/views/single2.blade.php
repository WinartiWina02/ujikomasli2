                                    ...
                                    <li><a href="#">Mega Menu</a>
                                        <div class="megamenu">
                                            <ul class="single-mega cn-col-4">
                                                <li class="title">Universitas</li>
                                                <li><a href="single">UNPAD</a></li>
                                                <li><a href="single">UPI</a></li>
                                                <li><a href="single">UIN</a></li>
                                            </ul>
                                            <ul class="single-mega cn-col-4">
                                                <li class="title">INSTITUT</li>
                                                <li><a href="single">INSTITUT TEKNOLOGI BANDUNG </a></li>
                                                <li><a href="single">INSTITUT SENI BUDAYA INDONESIA</a></li>
                                            </ul>
                                            <ul class="single-mega cn-col-4">
                                                <li class="title">SEKOLAH TINGGI</li>
                                                <li><a href="single">SEKOLAH TINGGI TEKSTIL</a></li>
                                                <li><a href="single">SEKOLAH TINGGI PARIWISATA</a></li>
                                            </ul>
                                             <ul class="single-mega cn-col-4">
                                                <li class="title">POLITEKNIK</li>
                                                <li><a href="single">POLITEKNIK NEGERI  BANDUNG</a></li>
                                                <li><a href="single">POLITEKNIK POS  INDONESIA</a></li>
                                            </ul>
                ...
                <div class="col-12 col-lg-8">
                    <div class="blog-posts-area">
                        ...
                        <div class="single-blog-post featured-post single-post">
                            ...
                            <div class="post-data">
                                <a href="" class="post-catagory">Hukum</a>
                                <a href="#" class="post-title">
                    ...
                    <div class="blog-sidebar-area">
                        ...
                        <div class="latest-posts-widget mb-50">
                            ...
                            <div class="single-blog-post small-featured-post d-flex">
                                ...
                                <div class="post-data">
                                    <a href="about" class="post-catagory">Hukum</a>
                                    <div class="post-meta">
                                        <a href="#" class="post-title">
                                            <h6>Pellentesque mattis arcu massa, nec fringilla turpis eleifend id.</h6>
                                        </a>
